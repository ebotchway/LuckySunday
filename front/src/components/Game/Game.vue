                ...
                <div class="controls">
                    <div class="row">
                        <div class="column align-center">
                            <img src="./assets/Up.png" :class="{ pressed: isUpButtonPressed }" v-on:click="buttonPressed(38)" alt="">
                        </div>
                    </div>
                    <div class="row">
                        <div class="column align-center">
                            <img src="./assets/Left.png" :class="{ pressed: isLeftButtonPressed }" v-on:click="buttonPressed(37)" alt="">
                            <img src="./assets/Down.png" :class="{ pressed: isDownButtonPressed }" v-on:click="buttonPressed(40)" alt="">
                            <img src="./assets/Right.png" :class="{ pressed: isRightButtonPressed }" v-on:click="buttonPressed(39)" alt="">
                        </div>
                    </div>
                </div>
            </div>
